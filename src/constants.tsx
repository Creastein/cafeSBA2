    ...
    categories: [
      {
        title: 'Special Menu',
        items: [
          { name: 'GF Strawberry Cheesecake', price: '51K', tags: ['GF'], image: '/hero-cake.png' },
          { name: 'Roasted Potato', price: '44K' },
          { name: 'Cheesy Clup Clup', price: '58K' },
          { name: 'Croissant Ice Cream', price: '37K', tags: ['Recommended'] },
          { name: 'Kopimisu', price: '56K', tags: ['GF'] },
          { name: 'Seasalt Brownies with Ice Cream', price: '47K', tags: ['GF'] },
          { name: 'Matchamisu', price: '53K', tags: ['GF'] },
        ]
      }
    ]
  }
