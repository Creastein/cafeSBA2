        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              <motion.a
                href={getWhatsAppUrl('Halo Sugar Bloom! Saya tertarik pesan custom cake 🎂 Bisa info detail prosesnya?')}
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(37, 211, 102, 0.25)" }}
                whileTap={{ scale: 0.95 }}
                className="h-16 px-10 bg-[#25D366] hover:bg-[#20BD5A] text-white font-bold rounded-2xl shadow-xl shadow-[#25D366]/20 transition-all inline-flex items-center justify-center gap-3"
              >
